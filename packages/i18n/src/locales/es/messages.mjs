...
export const messages = {
  ...
  "validation.password.minLength": "La contrasena debe tener al menos 8 caracteres",
  "validation.password.lowercase": "La contrasena debe contener una letra minuscula",
  "validation.password.uppercase": "La contrasena debe contener una letra mayuscula",
